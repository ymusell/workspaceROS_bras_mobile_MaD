...
int main(int argc, char **argv)
{
	...
	// On indique que l'on va lire les infos du topic /niryo_response (Signale au node si l'action est terminée ou non, publisher dans actions_niryo_final.py)
	...
	int test = 0;		//variable permettant de savoir savoir si le node de docking peut être lancé (quand le turtlebot est en attente de consigne)
